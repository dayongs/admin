    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="模块">
          <el-input v-model="form.module" min="1" style="width:200px"></el-input>
        </el-form-item>
        <el-form-item label="资源">
          <el-input v-model="form.resource" min="1" style="width:200px"></el-input>
...
export default {
  ...
  data() {
    return {
      listData: [],
      actions: ['findAll', 'findOne', 'create', 'update', 'delete'],
      form: {
        name: '',
        module: '',
        resource: '',
  ...
  methods: {
    ...
    async editOnSubmit() {
      this.loading = true
      const url = '/permissions/' + this.rowId
